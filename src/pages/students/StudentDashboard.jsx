                              ...
                              >
                                ...
                                <div className="relative z-10 h-full flex flex-col p-5">
                                  <div className="flex-grow flex flex-col items-center justify-center">
                                    ...
                                    />
                                    <div
                                      className="slogan text-sm italic text-center px-6 py-4 rounded-lg"
                                      style={{
                                        backgroundColor: colors.cardHighlight,
                                      }}
                                    >
                                      "Where code, knowledge, and innovation
                                      converge."
                                    </div>
                                    <div className="mt-8 text-center text-xs">
                                      ...
                                      <div className="text-xxs opacity-70">
                                        Property of Saint Columban College
                                      </div>
                                    </div>
                                  </div>
                                  <div className="links text-xxs text-center opacity-70">
                                    <div className="mb-1">
                                      https://facebook.com/SyBorgSCC
                                    </div>
                                    <div>
                                      https://facebook.com/ccs.saintcolumban
                                    </div>
                                  </div>
                                </div>
                              </div>
